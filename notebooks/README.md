...
- `ACMOT_FINAL_RUN_ALL_PIPELINE.ipynb`: one-cell final comparison of the live baseline and all three replay finalists. It uses clean T4/FP16 timing, official TrackEval, and explicit 25 FPS plus baseline-improvement gates.
